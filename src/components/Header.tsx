...
=======
  <header className="relative bg-gray-800 dark:bg-gray-900">
              ...
              <div className="flex items-center w-full max-w-2xl">
                <div className="relative flex-1">
                  <Input
                    ...
                    className="w-full h-12 pl-4 pr-12 bg-white/95 dark:bg-gray-800/95 dark:text-white border-0 rounded-l-lg focus:bg-white dark:focus:bg-gray-800 transition-colors shadow-lg placeholder:text-gray-500 dark:placeholder:text-gray-400"
